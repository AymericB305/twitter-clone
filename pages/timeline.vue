<template>
  <div class="flex">
    ...
    <div class="w-2/5 text-white pl-32 py-4 h-auto">
      ...
      <nav class="mt-5 px-2">
        <a href="#"
          class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-slate-800 text-blue-300">
        ...
        <a href="#"
          class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-slate-800 hover:text-blue-300">
        ...
        <a href="#"
          class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-slate-800 hover:text-blue-300">
          <svg class="mr-4 h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            stroke="currentColor" viewBox="0 0 24 24">
            <path
        ...
        <button class="bg-slate-400 w-48 mt-5 hover:bg-slate-600 text-white font-bold py-2 px-4 rounded-full">
          Tweet
        </button>
      </nav>

      <div class="flex-shrink-0 flex hover:bg-slate-00 rounded-full p-4 mt-12 mr-2">
    ...
    <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
      ...
      <div class="flex">
        ...
        <div class="flex-1 px-4 py-2 m-2">
          <a href=""
            class=" text-2xl font-medium rounded-full text-white hover:bg-slate-800 hover:text-blue-300 float-right">
      ...
      <div class="flex">
        ...
        <div class="w-64 px-2">
          ...
          <div class="flex items-center">
            <div class="flex-1 text-center px-1 py-1 m-2">
              <a href="#"
                class="mt-1 group flex items-center text-blue-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-slate-800 hover:text-blue-300">
        ...
        <div class="flex-1">
          <button class="bg-slate-400 mt-5 hover:bg-slate-600 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
            Tweet
          </button>
        </div>
      </div>

      <hr class="border-slate-800 border-4">
          ...
          <div class="w-full">
            ...
            <div class="flex items-center">
              <div class="flex-1 text-center">
                <a href="#"
                  class="w-12 mt-1 group flex items-center text-gray-500 px-3 py-2 text-base leading-6 font-medium rounded-full hover:bg-slate-800 hover:text-blue-300">
    ...
    <div class="w-2/5 h-12">
      ...
      <div class="relative text-gray-300 w-80 p-5 pb-0 mr-16">
        ...
        <input type="search" name="search" placeholder="Search Twitter"
          class="bg-slate-800 h-10 px-10 pr-5 w-full text-sm focus:outline-none bg-purple-white shadow rounded border-0">

      </div>

      <!--second-trending tweet section-->
      <div class="max-w-sm rounded-lg bg-slate-800 overflow-hidden shadow-lg m-4 mr-20">
        <div class="flex">
          <div class="flex-1 m-2">
            <h2 class="px-4 py-2 text-xl w-48 font-semibold text-white">Germany trends</h2>
          </div>
          <div class="flex-1 px-4 py-2 m-2">
            <a href="" class=" text-2xl rounded-full text-white hover:bg-slate-800 hover:text-blue-300 float-right">
      ...
      <div class="flex">
        ...
        <div class="flex-1 px-4 py-2 m-2">
          <a href="" class=" text-2xl rounded-full text-gray-400 hover:bg-slate-800 hover:text-blue-300 float-right">
      ...
      <div class="flex flex-shrink-0">
        ...
        <div class="flex-1 px-4 py-2 m-2">
          <a href="" class=" float-right">
            <button
              class="bg-transparent hover:bg-slate-500 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded-full">
              Follow
            </button>
          </a>
